...
const AchievementsSection = dynamic(
  () => import("./components/achievement-section"),
  { ssr: false }
);
const DataSightShowcase = dynamic(
  () => import("./components/datasight-section"),
  { ssr: false }
);
