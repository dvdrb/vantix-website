...
export const metadata: Metadata = {
  title: {
    ...
    default: 'VANTIX - Soluții Software Inovative | DataSight & Dezvoltare Custom',
  },
  description: 'VANTIX oferă soluții software inovative în România. Specializați în DataSight pentru analiza datelor, dezvoltare aplicații web și mobile, consultanță IT și servicii de digitalizare pentru afaceri moderne.',
  keywords: [
    'VANTIX',
    'software România',
    'DataSight',
  ...
  openGraph: {
    ...
    locale: 'ro_RO',
    url: 'https://vantix.ro',
    title: 'VANTIX - Soluții Software Inovative | DataSight & Dezvoltare Custom',
    description: 'Specializați în DataSight pentru analiza datelor, dezvoltare aplicații web și mobile, consultanță IT și servicii de digitalizare pentru afaceri moderne în România.',
    siteName: 'VANTIX',
    images: [
      {
        url: '/og-image.png',
  ...
  twitter: {
    ...
    description: 'Specializați în DataSight pentru analiza datelor și dezvoltare aplicații custom în România.',
